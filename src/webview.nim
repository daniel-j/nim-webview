...
when defined(linux):
  ...
  when defined(mingw):
    ...
    const webview2Dir = inclDir /../ "script" / "nuget" / "Microsoft.Web.WebView2.0.9.579" / "build" / "native" / "include"
    const webview2Lib = inclDir /../ "script" / "nuget" / "Microsoft.Web.WebView2.0.9.579" / "build" / "native" / "x64" / "WebView2Loader.dll.lib"
